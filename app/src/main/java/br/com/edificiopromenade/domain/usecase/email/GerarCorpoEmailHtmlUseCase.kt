...
class GerarCorpoEmailHtmlUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        demonstrativos: List<DemonstrativoHistoricoUi>,
        ...
        val listaBoletosHtml = buildString {
            demonstrativos.forEach { demo ->
                append("<li><strong>AP ${demo.numeroApartamento} - ${demo.nomeMorador}:</strong> ")
        ...
        return templateEngine.render(
            ...
            mapOf(
                "MES" to mesNome,
                "ANO" to ano.toString(),
                "TABELA_DESPESAS" to tabelaDespesasHtml,
                "LISTA_BOLETOS" to listaBoletosHtml,
